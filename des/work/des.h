...
// 初始置换表
const int TRANS_INIT[] = {58, 50, 42, 34, 26, 18, 10, 2,  60, 52, 44, 36, 28,
...
// 结尾置换表
const int TRANS_END[] = {40, 8,  48, 16, 56, 24, 64, 32, 39, 7,  47, 15, 55,
...
const int TRANS_56to48[] = {14, 17, 11, 24, 1,  5,  3,  28, 15, 6,  21, 10,
...
// 扩展置换表：将32位扩展至48位
const int EXPAND_32to48[] = {32, 1,  2,  3,  4,  5,  4,  5,  6,  7,  8,  9,
...
// 32位置换，32位 -> 32位
const int TRANS_32to32[] = {16, 7, 20, 21, 29, 12, 28, 17, 1,  15, 23,
